...
window.addEventListener('error', function(e){
  ...
  if(v && !v.innerHTML.trim()){ v.innerHTML='<section class="panel"><div class="eyebrow">KOLDIS</div><h1 class="title">Einen Moment – KOLDIS konnte nicht geladen werden.</h1><p class="sub">Bitte Seite neu laden.</p><button class="btn" onclick="location.reload()">Neu laden</button></section>'; }
});
